...
abstract class Controller extends \stdClass
{
     ...
     * @return array
     */
    protected function _vali(array $rules, $input = '', ?callable $callable = null): array
    {
        return ValidateHelper::instance()->init($rules, $input, $callable);
    }
